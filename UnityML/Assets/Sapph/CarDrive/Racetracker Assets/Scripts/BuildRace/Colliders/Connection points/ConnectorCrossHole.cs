...
public class ConnectorCrossHole : Connectionpoint
{

	public ConnectorCrossHole(PartDirection facedDirection, Vector3 relativePosition)
    {
        type = ConnectorType.CROSS_HOLE;
