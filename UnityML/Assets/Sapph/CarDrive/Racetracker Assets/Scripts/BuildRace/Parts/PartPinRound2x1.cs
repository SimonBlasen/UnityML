...
public class PartPinRound2x1 : Part
{
    public PartPinRound2x1()
    {
        FillData();
    }
    ...
    protected override List<Vector3> GenerateVertices(PartDirection direction, PartRotation rotation, int posX, int posY, int posZ)
    {
        ...
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.125f, posY - 0.25f, posZ + 1.5f)));                       // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.25f, posY - 0.125f, posZ + 1.5f)));                       // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.125f, posY - 0.25f, posZ + 1.5f)));                       // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.25f, posY - 0.125f, posZ + 1.5f)));                       // 0
