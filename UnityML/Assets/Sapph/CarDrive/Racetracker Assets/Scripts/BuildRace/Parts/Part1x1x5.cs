...
public class Part1x1x5 : Part
{
    ...
    protected override List<Vector3> GenerateVertices(PartDirection direction, PartRotation rotation, int posX, int posY, int posZ)
    {
        ...
        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.5f, posY - 0.5f, posZ - (((float)amountOfHoles) * 0.5f) + 4.75f)));                   // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.5f, posY - 0.5f, posZ - (((float)amountOfHoles) * 0.5f) + 4.75f)));                       // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.5f, posY - 0.5f + 0.25f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));               // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.5f, posY - 0.5f + 0.25f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));                   // 0

        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.5f, posY - 0.5f + 0.25f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));                       // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.5f, posY - 0.5f + 0.25f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));                   // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.5f, posY - 0.5f + 0.75f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));                       // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.5f, posY - 0.5f + 0.75f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));                   // 0

        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.5f, posY - 0.5f + 0.75f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));                       // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.5f, posY - 0.5f + 0.75f, posZ - (((float)amountOfHoles) * 0.5f) + 5)));                   // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX + 0.5f, posY - 0.5f + 1, posZ - (((float)amountOfHoles) * 0.5f) + 4.75f)));                   // 0
        verts.Add(rotAxis * rotQuat * (new Vector3(posX - 0.5f, posY - 0.5f + 1, posZ - (((float)amountOfHoles) * 0.5f) + 4.75f)));               // 0
