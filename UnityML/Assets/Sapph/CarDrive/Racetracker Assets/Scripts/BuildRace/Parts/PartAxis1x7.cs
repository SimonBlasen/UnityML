...
public class PartAxis1x7 : Part
{
    ...
    public override Connectionpoint[] GetConnectionpoints(PartDirection direction, PartRotation rotation)
    {
        ...
        connectionPoints[0] = new ConnectorCrossPin(direction, directionVector * 6);
        connectionPoints[1] = new ConnectorCrossPin(direction, directionVector * 5);
        connectionPoints[2] = new ConnectorCrossPin(direction, directionVector * 4);
        connectionPoints[3] = new ConnectorCrossPin(direction, directionVector * 3);
        connectionPoints[4] = new ConnectorCrossPin(direction, directionVector * 2);
        connectionPoints[5] = new ConnectorCrossPin(direction, directionVector);
        connectionPoints[6] = new ConnectorCrossPin(direction.Opposite(), new Vector3(0f, 0f, 0f));
