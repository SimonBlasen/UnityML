...
public class PartGearCorner4 : Part
{
    public PartGearCorner4()
    {
        FillData();
    }
    ...
    private Vector2 uvPos = new Vector2(4, 7);
    ...
    public override Connectionpoint[] GetConnectionpoints(PartDirection direction, PartRotation rotation)
    {
        ...
        connectionPoints[0] = new ConnectorGearCorner(direction, sideVector + upVector);
        connectionPoints[1] = new ConnectorGearCorner(direction, sideVector);
        connectionPoints[2] = new ConnectorGearCorner(direction, sideVector - upVector);
        connectionPoints[3] = new ConnectorGearCorner(direction, upVector);
        connectionPoints[4] = new ConnectorCrossHole(direction, new Vector3(0, 0, 0));
        connectionPoints[5] = new ConnectorGearCorner(direction, -upVector);
        connectionPoints[6] = new ConnectorGearCorner(direction, -sideVector + upVector);
        connectionPoints[7] = new ConnectorGearCorner(direction, -sideVector);
        connectionPoints[8] = new ConnectorGearCorner(direction, -sideVector - upVector);
