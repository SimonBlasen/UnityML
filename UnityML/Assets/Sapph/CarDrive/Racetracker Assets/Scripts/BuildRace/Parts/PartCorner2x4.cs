...
public class PartCorner2x4 : Part
{
    int amountOfHoles = 5;

    private Vector2 uvPos = new Vector2(1, 4);

    public PartCorner2x4()
    {
        FillData();
    }
    ...
    public override Connectionpoint[] GetConnectionpoints(PartDirection direction, PartRotation rotation)
    {
        ...
        connectionPoints[0] = new ConnectorRoundHole(holesLookDirection, directionUp);
        connectionPoints[1] = new ConnectorRoundHole(holesLookDirection, Vector3.zero);
        connectionPoints[2] = new ConnectorRoundHole(holesLookDirection, directionToGoIn);
        connectionPoints[3] = new ConnectorRoundHole(holesLookDirection, directionToGoIn * 2);
        connectionPoints[4] = new ConnectorRoundHole(holesLookDirection, directionToGoIn * 3);
