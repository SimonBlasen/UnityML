...
public class PartAxis1x6 : Part
{
    ...
    {
        Connectionpoint[] connectionPoints = new Connectionpoint[6];

        Vector3 directionVector = direction.ToVector3();

        connectionPoints[0] = new ConnectorCrossPin(direction, directionVector * 5);
        connectionPoints[1] = new ConnectorCrossPin(direction, directionVector * 4);
        connectionPoints[2] = new ConnectorCrossPin(direction, directionVector * 3);
        connectionPoints[3] = new ConnectorCrossPin(direction, directionVector * 2);
        connectionPoints[4] = new ConnectorCrossPin(direction, directionVector);
        connectionPoints[5] = new ConnectorCrossPin(direction.Opposite(), new Vector3(0f, 0f, 0f));
