...
public class PartSteerWheel : Part
{
    public PartSteerWheel()
    {
        FillData();
    }
    ...
    int amountOfEdgesAtBorder = 16;
    float fullDiameter = 2.8f;
    float innerDiameter = 2.5f;
    float wheelWidth = 0.8f;
    ...
    public override Connectionpoint[] GetConnectionpoints(PartDirection direction, PartRotation rotation)
    {
        ...
        connectionPoints[0] = new ConnectorCrossHole(direction, Vector3.zero);
        connectionPoints[1] = new ConnectorSolid(direction, firstHoleDirection.ToVector3() + secondHoleDirection.ToVector3());
        connectionPoints[2] = new ConnectorSolid(direction, firstHoleDirection.ToVector3());
        connectionPoints[3] = new ConnectorSolid(direction, firstHoleDirection.ToVector3() - secondHoleDirection.ToVector3());
        connectionPoints[4] = new ConnectorSolid(direction, secondHoleDirection.ToVector3());
        connectionPoints[5] = new ConnectorSolid(direction, -secondHoleDirection.ToVector3());
        connectionPoints[6] = new ConnectorSolid(direction, -firstHoleDirection.ToVector3() + secondHoleDirection.ToVector3());
        connectionPoints[7] = new ConnectorSolid(direction, -firstHoleDirection.ToVector3());
        connectionPoints[8] = new ConnectorSolid(direction, -firstHoleDirection.ToVector3() - secondHoleDirection.ToVector3());
    ...
    private Vector2 outer = new Vector2(4, 4);
    private Vector2 innner = new Vector2(7, 4);
