...
public class PartWeaponMinigun_1 : Part
{
    public PartWeaponMinigun_1()
    {
        FillData();
    }
    ...
    public override Connectionpoint[] GetConnectionpoints(PartDirection direction, PartRotation rotation)
    {
        ...
        connectionPoints[0] = new ConnectorSolid(direction, 3 * directionToGoIn + Vector3.zero);

        connectionPoints[1] = new ConnectorSolid(direction, 4 * directionToGoIn + Vector3.zero);

        connectionPoints[2] = new ConnectorSolid(direction, 5 * directionToGoIn + Vector3.zero);

        connectionPoints[3] = new ConnectorSolid(direction, 6 * directionToGoIn + Vector3.zero);
