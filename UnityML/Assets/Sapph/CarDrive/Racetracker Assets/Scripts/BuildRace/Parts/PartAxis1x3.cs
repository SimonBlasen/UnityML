...
public class PartAxis1x3 : Part
{
    ...
    public override Connectionpoint[] GetConnectionpoints(PartDirection direction, PartRotation rotation)
    {
        ...
        connectionPoints[0] = new ConnectorCrossPin(direction, directionVector * 2);
        connectionPoints[1] = new ConnectorCrossPin(direction, directionVector);
        connectionPoints[2] = new ConnectorCrossPin(direction.Opposite(), new Vector3(0f, 0f, 0f));
