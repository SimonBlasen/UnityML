...
public class PartToothBar5 : Part
{
    int amountOfHoles = 5;

    private Vector2 uvPos = new Vector2(1, 4);

    public PartToothBar5()
    {
        FillData();
    }
    ...
    protected override List<Vector3> GenerateVertices(PartDirection direction, PartRotation rotation, int posX, int posY, int posZ)
    {
        ...
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, -4f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, -4f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, 4f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, 4f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, -4f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, -4f, -1f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, 4f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -1f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, -4f, -1f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, -4f, 1f)) * fac));
        ...
        verts.Add(rotAxis * rotQuat * ((new Vector3(-2f, -4f, -1f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, -4f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, -4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, -4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, 4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, 4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, -4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, -4f, -17f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, 4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -17f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, -4f, -17f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, -4f, -15f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -17f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -15f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, -4f, -15f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, -4f, -14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -15f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, 4f, -14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, -4f, -14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, -4f, -14f)) * fac));
        ...
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, -4f, 14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, 4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, 4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-2f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-1f, 4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-2f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-2f, 4f, -17f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -17f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(1f, 4f, -18f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(2f, 4f, -20f)) * fac));
        ...
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 4f, 20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, 20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 4f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -20f)) * fac));
        ...
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -16f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -16f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, 20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, 20f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, 16f)) * fac));
        ...
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -16f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -16f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -14f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -12f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -12f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -12f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -12f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -10f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -10f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -10f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -10f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -8f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -8f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -8f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -8f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -6f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -6f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -6f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -6f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -4f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -4f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, -4f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, -4f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 7f, -2f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, 0f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, 0f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 5f, 0f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(4f, 5f, 0f)) * fac));
        verts.Add(rotAxis * rotQuat * ((new Vector3(-4f, 7f, 2f)) * fac));
